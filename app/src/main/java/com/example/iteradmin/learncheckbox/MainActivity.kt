package com.example.iteradmin.learncheckbox
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    override fun onClick(v: View) {
        when(v.id)
        {
            ...
            R.id.checkBox5->{
                val s:String = findViewById<CheckBox>(R.id.checkBox5).text.toString()
                toast(s)
            }
        }
    }
    ...
    {
        Toast.makeText(applicationContext,message + " will be our PM.",Toast.LENGTH_LONG).show()
    }
